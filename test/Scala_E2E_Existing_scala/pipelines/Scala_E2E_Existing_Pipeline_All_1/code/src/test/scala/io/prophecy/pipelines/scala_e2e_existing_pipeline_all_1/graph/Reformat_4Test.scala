...
class Reformat_4Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/Reformat_4/in/schema.json",
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/Reformat_4/in/data/unit_test_.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/Reformat_4/out/schema.json",
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/Reformat_4/out/data/unit_test_.json",
      "out"
    )
