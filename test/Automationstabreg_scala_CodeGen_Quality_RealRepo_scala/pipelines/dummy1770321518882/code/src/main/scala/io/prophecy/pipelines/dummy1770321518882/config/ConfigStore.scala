package io.prophecy.pipelines.dummy1770321518882.config

import io.prophecy.pipelines.dummy1770321518882.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1770321518882")
