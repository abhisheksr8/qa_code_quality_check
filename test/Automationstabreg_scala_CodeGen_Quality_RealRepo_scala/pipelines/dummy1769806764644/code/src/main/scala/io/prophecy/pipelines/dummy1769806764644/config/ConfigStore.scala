package io.prophecy.pipelines.dummy1769806764644.config

import io.prophecy.pipelines.dummy1769806764644.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1769806764644")
