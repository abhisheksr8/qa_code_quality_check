...
from python_e2e_existing_pipeline_all_1.graph.Reformat_1 import *
...
class Reformat_1Test(BaseTestCase):
    ...
    def test_unit_test_(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/python_e2e_existing_pipeline_all_1/graph/Reformat_1/in0/schema.json',
            'test/resources/data/python_e2e_existing_pipeline_all_1/graph/Reformat_1/in0/data/test_unit_test_.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/python_e2e_existing_pipeline_all_1/graph/Reformat_1/out/schema.json',
            'test/resources/data/python_e2e_existing_pipeline_all_1/graph/Reformat_1/out/data/test_unit_test_.json',
            'out'
        )
