package io.prophecy.pipelines.dummy1753964859384.config

import io.prophecy.pipelines.dummy1753964859384.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1753964859384")
