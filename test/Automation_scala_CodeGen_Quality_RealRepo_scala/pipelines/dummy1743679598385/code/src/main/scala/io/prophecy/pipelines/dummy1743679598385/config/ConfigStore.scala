package io.prophecy.pipelines.dummy1743679598385.config

import io.prophecy.pipelines.dummy1743679598385.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1743679598385")
