package io.prophecy.pipelines.dummy1748726692032.config

import io.prophecy.pipelines.dummy1748726692032.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1748726692032")
