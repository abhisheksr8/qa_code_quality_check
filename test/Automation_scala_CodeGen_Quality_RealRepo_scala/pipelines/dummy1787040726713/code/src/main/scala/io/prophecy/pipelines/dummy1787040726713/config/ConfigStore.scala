package io.prophecy.pipelines.dummy1787040726713.config

import io.prophecy.pipelines.dummy1787040726713.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1787040726713")
