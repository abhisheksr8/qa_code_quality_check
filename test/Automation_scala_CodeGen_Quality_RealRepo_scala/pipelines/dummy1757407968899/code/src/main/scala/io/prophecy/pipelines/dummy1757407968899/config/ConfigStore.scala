package io.prophecy.pipelines.dummy1757407968899.config

import io.prophecy.pipelines.dummy1757407968899.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1757407968899")
