package io.prophecy.pipelines.dummy1779816858422.config

import io.prophecy.pipelines.dummy1779816858422.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1779816858422")
