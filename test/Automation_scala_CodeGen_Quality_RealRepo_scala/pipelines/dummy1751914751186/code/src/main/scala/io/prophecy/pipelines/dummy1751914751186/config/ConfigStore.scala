package io.prophecy.pipelines.dummy1751914751186.config

import io.prophecy.pipelines.dummy1751914751186.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1751914751186")
