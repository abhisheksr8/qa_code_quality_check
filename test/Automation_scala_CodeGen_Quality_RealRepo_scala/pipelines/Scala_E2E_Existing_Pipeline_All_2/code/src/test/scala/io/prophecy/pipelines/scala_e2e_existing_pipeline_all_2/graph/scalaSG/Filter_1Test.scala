...
class Filter_1Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_2/graph/scalaSG/Filter_1/in/schema.json",
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_2/graph/scalaSG/Filter_1/in/data/unit_test_.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_2/graph/scalaSG/Filter_1/out/schema.json",
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_2/graph/scalaSG/Filter_1/out/data/unit_test_.json",
      "out"
    )
  ...
  test("Unit Test _1") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_2/graph/scalaSG/Filter_1/in/schema.json",
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_2/graph/scalaSG/Filter_1/in/data/unit_test__1.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_2/graph/scalaSG/Filter_1/out/schema.json",
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_2/graph/scalaSG/Filter_1/out/data/unit_test__1.json",
      "out"
    )
