package io.prophecy.pipelines.dummy1744075354814.config

import io.prophecy.pipelines.dummy1744075354814.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1744075354814")
