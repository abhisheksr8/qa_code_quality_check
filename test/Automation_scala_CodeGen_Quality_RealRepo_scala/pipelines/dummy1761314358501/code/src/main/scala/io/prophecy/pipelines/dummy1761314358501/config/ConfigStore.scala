package io.prophecy.pipelines.dummy1761314358501.config

import io.prophecy.pipelines.dummy1761314358501.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1761314358501")
