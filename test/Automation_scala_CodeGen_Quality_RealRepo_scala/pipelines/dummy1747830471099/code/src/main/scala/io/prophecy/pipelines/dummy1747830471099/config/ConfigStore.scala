package io.prophecy.pipelines.dummy1747830471099.config

import io.prophecy.pipelines.dummy1747830471099.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1747830471099")
