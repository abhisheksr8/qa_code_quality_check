package io.prophecy.pipelines.dummy1756372801057.config

import io.prophecy.pipelines.dummy1756372801057.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1756372801057")
