...
class Reformat_2_1Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/Reformat_2_1/in/schema.json",
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/Reformat_2_1/in/data/unit_test_.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/Reformat_2_1/out/schema.json",
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/Reformat_2_1/out/data/unit_test_.json",
      "out"
    )

    val dfOutComputed =
      io.prophecy.pipelines.scala_e2e_existing_pipeline_all_1.graph
        .Reformat_2_1(context, dfIn)
