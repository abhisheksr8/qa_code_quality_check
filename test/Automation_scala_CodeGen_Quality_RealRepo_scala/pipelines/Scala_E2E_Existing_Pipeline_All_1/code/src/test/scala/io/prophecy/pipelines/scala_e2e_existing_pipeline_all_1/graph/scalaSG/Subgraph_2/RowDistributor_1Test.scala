...
class RowDistributor_1Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/scalaSG/Subgraph_2/RowDistributor_1/in/schema.json",
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/scalaSG/Subgraph_2/RowDistributor_1/in/data/unit_test_.json",
      "in"
    )
    val dfOut0 = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/scalaSG/Subgraph_2/RowDistributor_1/out0/schema.json",
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/scalaSG/Subgraph_2/RowDistributor_1/out0/data/unit_test_.json",
      "out0"
    )
    val dfOut1 = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/scalaSG/Subgraph_2/RowDistributor_1/out1/schema.json",
      "/data/io/prophecy/pipelines/scala_e2e_existing_pipeline_all_1/graph/scalaSG/Subgraph_2/RowDistributor_1/out1/data/unit_test_.json",
      "out1"
    )

    val (dfOut0Computed, dfOut1Computed) =
      io.prophecy.pipelines.scala_e2e_existing_pipeline_all_1.graph.scalaSG.Subgraph_2
        .RowDistributor_1(
          io.prophecy.pipelines.scala_e2e_existing_pipeline_all_1.graph.scalaSG.Subgraph_2.config
