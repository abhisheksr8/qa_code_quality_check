package io.prophecy.pipelines.dummy1754591332542.config

import io.prophecy.pipelines.dummy1754591332542.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1754591332542")
