package io.prophecy.pipelines.dummy1764225804660.config

import io.prophecy.pipelines.dummy1764225804660.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1764225804660")
