package io.prophecy.pipelines.dummy1784465745983.config

import io.prophecy.pipelines.dummy1784465745983.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1784465745983")
