package io.prophecy.pipelines.dummy1744845276885.config

import io.prophecy.pipelines.dummy1744845276885.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1744845276885")
