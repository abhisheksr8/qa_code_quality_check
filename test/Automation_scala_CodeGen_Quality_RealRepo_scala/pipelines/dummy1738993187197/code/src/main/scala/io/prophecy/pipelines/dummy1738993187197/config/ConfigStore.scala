package io.prophecy.pipelines.dummy1738993187197.config

import io.prophecy.pipelines.dummy1738993187197.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1738993187197")
