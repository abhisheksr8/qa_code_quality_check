package io.prophecy.pipelines.dummy1756113000401.config

import io.prophecy.pipelines.dummy1756113000401.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args, "", "io/prophecy/pipelines/dummy1756113000401")
